...
teacher_projector.load_state_dict(torch.load("/content/drive/MyDrive/tensorstorage/teacher_projector_weights.pth"))
...
with open('/content/drive/MyDrive/tensorstorage/all_doc_embeds.pkl', 'rb') as f:
...
output_dir = "/content/drive/MyDrive/tensorstorage/distilled_model"
