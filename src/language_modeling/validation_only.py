...
def main():
    ...
    if dev_dataloader is not None and args.task_type == 'pretrain':
        ...
        accelerator.log({"initial_dev_ppl": ppl}, step=0)
        accelerator.print(f"Initial dev_ppl: {ppl}")
    ...
    if accelerator.is_main_process:
        ...
        api.upload_folder(
            ...
            repo_id=repo_name,
            commit_message="Initial model without training"
        )
        
        accelerator.print(f"Model pushed to https://huggingface.co/{repo_name}")
